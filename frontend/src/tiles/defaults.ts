...
//{ i: 'recommendations', x: 4, y: 3,  w: 5,  h: 8, minW: 2, minH: 4 },
  ...
  { i: 'expected-draws',  x: 6, y: 25, w: 6,  h: 8, minW: 4, minH: 5 },
]
...
//{ i: 'recommendations', x: 5, y: 3,  w: 5,  h: 8, minW: 2, minH: 4 },
  ...
  { i: 'expected-draws',  x: 6, y: 30, w: 4,  h: 8, minW: 4, minH: 5 },
]
...
//{ i: 'recommendations', x: 3, y: 10, w: 3, h: 8, minW: 2, minH: 4 },
  ...
  { i: 'expected-draws',  x: 0, y: 67, w: 6, h: 8, minW: 4, minH: 5 },
]
...
const LG_LAYOUT_3P: LayoutItem[] = [
  ...
  { i: 'expected-draws',  x: 6, y: 33, w: 6,  h: 8, minW: 4, minH: 5 },
]
...
const MD_LAYOUT_3P: LayoutItem[] = [
  ...
  { i: 'board',           x: 0, y: 33, w: 6,  h: 14, minW: 4, minH: 8 },
  { i: 'expected-draws',  x: 6, y: 33, w: 4,  h: 8, minW: 4, minH: 5 },
]
